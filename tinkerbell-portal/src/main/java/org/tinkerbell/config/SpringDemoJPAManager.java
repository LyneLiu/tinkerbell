...
@EntityScan(basePackages = "org.tinkerbell.entity.po.springdemo")
@EnableJpaRepositories(basePackages = "org.tinkerbell.repository.springdemo",
...
public class SpringDemoJPAManager {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactorySecondary(EntityManagerFactoryBuilder builder) {
        return builder
                ...
                .packages("org.tinkerbell.entity.po.springdemo") //设置实体类所在位置
