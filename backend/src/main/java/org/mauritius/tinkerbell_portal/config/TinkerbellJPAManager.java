...
@EntityScan(basePackages = "org.mauritius.tinkerbell_portal.entity.po.tinkerbell")
@EnableJpaRepositories(
        entityManagerFactoryRef = "entityManagerFactoryTinkerbell",
        transactionManagerRef = "transactionManagerTinkerbell",
        basePackages = {"org.mauritius.tinkerbell_portal.repository.tinkerbell"}) //设置Repository所在位置
public class TinkerbellJPAManager {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryPrimary(EntityManagerFactoryBuilder builder) {
        return builder
                ...
                .packages("org.mauritius.tinkerbell_portal.entity.po.tinkerbell") //设置实体类所在位置
